...
-- =====================================================
-- UNSOLVED PRACTICE PROBLEMS ON WINDOW FUNCTIONS (MySQL)
-- =====================================================

/*
INSTRUCTIONS FOR STUDENTS:
1. Do NOT use GROUP BY unless explicitly required.
2. Use WINDOW FUNCTIONS only.
3. Each row must be visible in output.
*/

-- -----------------------------------------------------
-- Problem 1: Ranking Within Department
-- -----------------------------------------------------
-- Scenario:
-- Display employees with their rank based on salary
-- within each department (highest salary = rank 1).

-- Task:
-- Use a ranking window function.


-- -----------------------------------------------------
-- Problem 2: Dense Ranking for Bonus Eligibility
-- -----------------------------------------------------
-- Scenario:
-- Employees with the same salary should get the same rank,
-- and the next rank should NOT be skipped.

-- Task:
-- Use a window function that avoids rank gaps.


-- -----------------------------------------------------
-- Problem 3: Department-wise Salary Difference
-- -----------------------------------------------------
-- Scenario:
-- Show each employee’s salary along with the salary
-- of the previous employee in the same department.

-- Task:
-- Use a value window function.


-- -----------------------------------------------------
-- Problem 4: Salary Increase Analysis
-- -----------------------------------------------------
-- Scenario:
-- For each department, show the difference between
-- current employee salary and next employee salary.

-- Task:
-- Use a window function to access the next row.


-- -----------------------------------------------------
-- Problem 5: Running Total of Salaries
-- -----------------------------------------------------
-- Scenario:
-- Display a running total of salaries
-- ordered by employee_id across all employees.
...
-- -----------------------------------------------------
-- Problem 6: Department-wise Average Comparison
-- -----------------------------------------------------
-- Scenario:
...
-- Task:
-- Use AVG() with PARTITION BY.


-- -----------------------------------------------------
-- Problem 7: Salary Quartile Classification
-- -----------------------------------------------------
-- Scenario:
...
-- Task:
-- Use an analytic window function.


-- -----------------------------------------------------
-- Problem 8: First and Last Salary in Department
-- -----------------------------------------------------
-- Scenario:
-- Display each employee along with:
-- 1) Lowest salary in their department
-- 2) Highest salary in their department

-- Task:
-- Use value window functions with proper framing.


-- -----------------------------------------------------
-- Problem 9: Moving Average Salary
-- -----------------------------------------------------
-- Scenario:
-- Calculate a moving average salary considering
-- current employee and previous two employees
-- ordered by employee_id.

-- Task:
-- Use ROWS frame specification.


-- -----------------------------------------------------
-- Problem 10: Cumulative Employee Count
-- -----------------------------------------------------
-- Scenario:
-- Show cumulative count of employees
