...
-- =====================================================
-- UNSOLVED PRACTICE PROBLEMS ON TRIGGERS (MySQL)
-- =====================================================

/*
IMPORTANT:
1. Do NOT write the trigger code yet.
...
-- -----------------------------------------------------
-- Problem 1: BEFORE INSERT Trigger
-- -----------------------------------------------------
-- Scenario:
-- While inserting a new account, ensure the minimum opening balance is 500.
-- If balance < 500, stop the insertion and raise a custom error.

-- Task:
-- Create a BEFORE INSERT trigger on Accounts
-- Use SIGNAL SQLSTATE '45000'


-- -----------------------------------------------------
-- Problem 2: AFTER INSERT Trigger
-- -----------------------------------------------------
-- Scenario:
-- Every time a new account is created, insert a record into AuditLog
-- with old_balance = 0 and new_balance = inserted balance.

-- Task:
-- Create an AFTER INSERT trigger on Accounts


-- -----------------------------------------------------
-- Problem 3: BEFORE UPDATE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Prevent updating balance if the new balance is greater than
-- 2 times the old balance (sudden suspicious increase).

-- Task:
-- Create a BEFORE UPDATE trigger with validation logic


-- -----------------------------------------------------
-- Problem 4: AFTER UPDATE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Whenever an account balance is updated, store:
-- account_id, old_balance, new_balance, and update time in AuditLog.

-- Task:
-- Create an AFTER UPDATE trigger using OLD and NEW keywords


-- -----------------------------------------------------
-- Problem 5: BEFORE DELETE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Do not allow deletion of accounts where balance is greater than 1000.

-- Task:
-- Create a BEFORE DELETE trigger
-- Raise a custom error message if condition fails


-- -----------------------------------------------------
-- Problem 6: AFTER DELETE Trigger
-- -----------------------------------------------------
-- Scenario:
-- When an account is deleted, log the account holder name and balance
-- into DeletedAccountsLog table.
...
-- -----------------------------------------------------
-- Problem 7: BEFORE UPDATE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Prevent changing the AccountHolder name if balance is NOT zero.

-- Task:
-- Create a BEFORE UPDATE trigger
-- Compare OLD and NEW account holder names


-- -----------------------------------------------------
-- Problem 8: BEFORE INSERT Trigger
-- -----------------------------------------------------
-- Scenario:
-- Do not allow insertion of accounts where AccountHolder name
-- contains numeric characters (0–9).

-- Task:
-- Create a BEFORE INSERT trigger
-- Use string validation logic


-- -----------------------------------------------------
-- Problem 9: AFTER UPDATE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Maintain AccountSummary table:
-- Whenever balance changes, update total_balance correctly.

-- Task:
-- Create an AFTER UPDATE trigger
-- Adjust total_balance using difference logic


-- -----------------------------------------------------
-- Problem 10: BEFORE DELETE Trigger
-- -----------------------------------------------------
-- Scenario:
-- Allow deletion only if account balance is exactly 0
-- Otherwise, stop deletion with an error.

-- Task:
-- Create a BEFORE DELETE trigger using SIGNAL SQLSTATE
